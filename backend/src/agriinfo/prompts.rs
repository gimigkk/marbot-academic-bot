...
pub fn build_agriinfo_extraction_prompt(
    message: &str,
) -> String {
...
Kamu adalah asisten AI profesional untuk divisi/kepengurusan "Agriinformatics" (Agriinfo). 
Tugas utamamu adalah menganalisis pesan WhatsApp dari divisi Agriinfo dan mengekstrak agenda, jadwal rapat, atau tugas (task) jika ada.
